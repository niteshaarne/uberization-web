...
<%@ include file = "adminNavBar.jsp" %>
	...
	<div class="container">
		...
		<div class="col-md-4"></div>
			...
			<form id="publishWork"  action="publishWorkService" name="publishWorkName" method="POST" >
		...
		<div class="form-group">
			...
			<div class="input-group date">
				<input formControlName="dateOfWork" name = "dateOfWork" type="text" maxlength="14"
			...
			<input type="submit" [disabled] ="!formdata.valid"
				class="btn btn-primary" value="Publish Work">
	</form></div>
