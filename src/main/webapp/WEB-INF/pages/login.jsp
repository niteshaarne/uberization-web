...
<div class="col-md-4">
<form id="login"  action="loginService" class="" name="loginName" method="POST" >
  <div class="form-group">
    <!-- <label for="exampleInputEmail1">Email address</label> -->
    <input type="email" required name ="emailId"  class="form-control" id="exampleInputEmail1" placeholder="Enter email" size="45"  formControlName="emailid">
  </div>
  <div class="form-group">
    <!-- <label for="exampleInputPassword1">Password</label> -->
    <input type="password" required name="password" class="form-control" id="exampleInputPassword1" placeholder="Password" size="45" formControlName="passwd">
  </div>
